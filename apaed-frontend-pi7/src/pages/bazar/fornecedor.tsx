            ...
            <>
              <Button
                onClick={() => {
                  ...
                  props.history.push(`/${user.role.name === AUTHORITIES.BAZAR ? 'bazar' : 'bazar'}/viewFornecedor`);
                }}
                color="info"
              >
                    ...
                    if (result.isConfirmed) {
                      ...
                      if (deleteDonorSuccess && !deleteDonorError && !loading) {
                        ...
                        MySwal.fire({
                          ...
                          props.reset();
                          props.history.push('/bazar/fornecedor');
                        });
                      }
    ...
    <div className="d-flex h-100 align-items-center justify-content-center">
      <Card className="w-25 shadow-lg">
        ...
        <CardBody>
          <Button
            tag={Link}
            to={`/${user.role.name === AUTHORITIES.BAZAR ? 'bazar' : 'bazar'}/addFornecedor`}
