  ...
  render() {
    ...
    if (createProductSuccess && !createProductError && !loading) {
      ...
      MySwal.fire({
        ...
        this.props.history.push(`${user.role.name === AUTHORITIES.BAZAR ? '/bazar/addProduto' : '/bazar/addProduto'}`);
      });
      this.props.reset();
    }
    ...
    if (updateProductSuccess && !updateProductError && !loading) {
      ...
      MySwal.fire({
        ...
        this.props.history.push(`${user.role.name === AUTHORITIES.BAZAR ? '/bazar/products' : '/bazar/addProduto'}`);
      });
      this.props.reset();
    }
